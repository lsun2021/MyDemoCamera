package com.example.mystylebanner;
...
public class RecyclerViewBanner extends FrameLayout {
     ...
     * @param attrs
     */
    private void initRecycler(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RecyclerViewBanner);
         ...
         isShowIndicator = typedArray.getBoolean(R.styleable.RecyclerViewBanner_rvb_showIndicator,true);
         isAutoPlaying = typedArray.getBoolean(R.styleable.RecyclerViewBanner_rvb_autoPlaying,true);

        Drawable  sd = typedArray.getDrawable(R.styleable.RecyclerViewBanner_rvb_indicatorSelectedSrc);
        Drawable usd = typedArray.getDrawable(R.styleable.RecyclerViewBanner_rvb_indicatorUnselectedSrc);
        ...
        mSize = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBanner_rvb_indicatorSize,0);
        mSpace = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBanner_rvb_indicatorSpace,dp2px(4));
        int  margin = typedArray.getDimensionPixelSize(R.styleable.RecyclerViewBanner_rvb_indicatorMargin,dp2px(8));
        int  g = typedArray.getInt(R.styleable.RecyclerViewBanner_rvb_indicatorGravity,1);
        int  gravity ;
         if(g == 0){
     ...
     */
    public  void setIndicatorInverval(int millisecond){
    ...
    /**
     * 设置是否禁止滚动播放
     * @param isAutoPlaying  false 禁止自动滚动 ，true 设置自动滚动
     */
